...
#define SCREENSHOT_CMD "maim -s | tee ~/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png | xclip -selection clipboard -t image/png"
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray4, col_dark1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_dark2, col_primary },
};
